...
class Solution:
    def rob(self, nums: List[int]) -> int:
        ...
        # We solve the house robber problem twice, once without the first
        # house and the second time without the last house. We get the
        # max value of both outcomes, which is the robber's best outcome.
